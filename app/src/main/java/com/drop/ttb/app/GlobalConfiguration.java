...
import com.drop.ttb.BuildConfig;
import com.drop.ttb.R;
import com.drop.ttb.mvp.model.api.cache.CommonCache;
import com.drop.ttb.mvp.model.api.service.CommonService;
...
public class GlobalConfiguration implements ConfigModule {
    ...
    public void registerComponents(Context context, IRepositoryManager repositoryManager) {
        repositoryManager.injectRetrofitService(CommonService.class, TalkService.class);
...
//                这里全局给Activity设置toolbar和title,你想象力有多丰富,这里就有多强大,以前放到BaseActivity的操作都可以放到这里
                ...
                if (activity.findViewById(R.id.mytoolbar_title) != null) {
                    ((TextView) activity.findViewById(R.id.mytoolbar_title)).setText(activity.getTitle());
                }
                if (activity.findViewById(R.id.mytoolbar_back) != null) {
                    activity.findViewById(R.id.mytoolbar_back).setOnClickListener(v -> {
